from sqlalchemy import Column, Integer, String, Text, ForeignKey, Boolean, DateTime as DATETIME
...
class Announcement(Base):
    ...
    send_date_time = Column(DATETIME, default=datetime.datetime.now(), nullable=False, comment='送信日時')
...
class AnnouncementLog(Base):
    ...
    action_date_time = Column(DATETIME, default=datetime.datetime.now(), nullable=False)
