...
import tt_CourseTaking from '@/components/templates/teachers/tt_CourseTaking.vue'
...
<template>
  <div>
    <tc_access_time page='T_CourseTaking' :details="'course_id:'+course_id"/>
    <tt_Header :user_info='user_info'/>    
    <v-main>
      <v-container>
        <v-responsive :max-width='1200' class='mx-auto'>
          <v-container>
            <tt_SelectCourse location='T_CourseTaking'/>
            <v-row>
              <v-container class='pt-5'>
                <tt_CourseTaking :course_id='course_id' />
              </v-container>
            </v-row>
          </v-container>
        </v-responsive>
