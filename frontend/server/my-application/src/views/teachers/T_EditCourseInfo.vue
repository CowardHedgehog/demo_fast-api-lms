...
import tt_EditWeekInfo from '@/components/templates/teachers/tt_EditCourseInfo.vue'
...
<template>
  <div>
    <tc_access_time page='T_EditCourseInfo' :details="'course_id:'+course_id"/>
    <tt_Header :user_info='user_info'/>    
    <v-main>
      <v-container>
        <v-responsive :max-width='1200' class='mx-auto'>
          <v-container>
            <tt_SelectCourse location='T_EditCourseInfo' :course_id='course_id'/>
            <v-row>
              <v-container class='pt-5'>
                <!-- Component -->
                <tt_EditWeekInfo :course_id='course_id'/>
                <!-- End -->
              </v-container>
            </v-row>
          </v-container>
