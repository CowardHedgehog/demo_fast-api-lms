...
<template>
  <div>
    <tc_access_time page='T_FlowSession' :details="'course_id:'+course_id+',week_id:'+week_id+',flow_id:'+flow_id+',flow_session_id:'+flow_session_id"/>
    <tt_Header :user_info='user_info'/>    
    <v-main>
      <v-container>
        <v-responsive :max-width='1200' class='mx-auto'>
          <v-container>
            <tt_SelectCourse location='S_FlowSession'/>
            <v-row>
              <v-container class='pt-5'>
                <h2>{{ flow_title }}</h2>
                <tc_FlowSessionLocationBar :create='user_info.create' :course_id='course_id' :week_id='week_id' :flow_id='flow_id' :flow_session_id='flow_session_id' :page='page' :num_of_pages='num_of_pages'/>
                <tc_FlowSessionQuestion  :create='user_info.create' :course_id='course_id' :week_id='week_id' :flow_id='flow_id' :flow_session_id='flow_session_id' :page='page' :num_of_pages='num_of_pages'/>
              </v-container>
            </v-row>
          </v-container>
        </v-responsive>
