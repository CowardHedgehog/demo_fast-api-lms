...
import tt_UserSetting from '@/components/templates/teachers/tt_UserSetting.vue'
...
<template>
  <div>
    <tc_access_time page='T_UserSetting'/>
    <tt_Header :user_info='user_info'/>    
    <v-main>
      <v-container>
        <v-responsive :max-width='1200' class='mx-auto'>
          <v-container>
            <tt_SelectHome location='T_UserSetting'/>
            <v-row>
              <v-container class='pt-5'>
                <!-- Component -->
                 <tt_UserSetting :user_info='user_info' />
                <!-- End -->
              </v-container>
            </v-row>
          </v-container>
