...
import tt_Course from '@/components/templates/teachers/tt_Course.vue'
...
<template>
  <div>
    <tc_access_time page='T_Course' :details="'course_id:'+course_id"/>
    <tt_Header :user_info='user_info'/>    
    <v-main>
      <v-container>
        <v-responsive :max-width='1200' class='mx-auto'>
          <v-container>
            <tt_SelectCourse location='T_Course'/>
            <v-row>
              <v-container class='pt-5'>
                <tt_Course :create='user_info.create' :course_id='props.course_id' />
              </v-container>
            </v-row>
          </v-container>
        </v-responsive>
