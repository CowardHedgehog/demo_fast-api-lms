...
import tt_RegisterWeek from '@/components/templates/teachers/tt_RegisterWeek.vue'
...
<template>
  <div>
    <tc_access_time page='T_RegisterWeek' :details="'course_id:'+course_id"/>
    <tt_Header :user_info='user_info'/>    
    <v-main>
      <v-container>
        <v-responsive :max-width='1200' class='mx-auto'>
          <v-container>
            <tt_SelectCourse location='T_RegisterWeek'/>
            <v-row>
              <v-container class='pt-5'>
                <tt_RegisterWeek :course_id='course_id'/>
              </v-container>
            </v-row>
          </v-container>
        </v-responsive>
