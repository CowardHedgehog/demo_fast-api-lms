...
import tc_Flow from '@/components/templates/common/tc_Flow.vue'
...
<template>
  <div>
    <tc_access_time page='T_Flow' :details="'course_id:'+course_id+',week_id:'+week_id+',flow_id:'+flow_id"/>
          ...
          <v-container>
            ...
            <v-row>
              <v-container class='pt-5'>
                <!-- Component -->
                <tc_Flow :create='user_info.create' :course_id='course_id' :week_id='week_id' :flow_id='flow_id'/>
                <!-- End -->
              </v-container>
            </v-row>
          </v-container>
