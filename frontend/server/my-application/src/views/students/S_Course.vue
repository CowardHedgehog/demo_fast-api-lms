...
import ts_Course from '@/components/templates/students/ts_Course.vue'
...
<template>
  <div>
    <tc_access_time page='S_Course' :details="'course_id:' + course_id"/>
    <ts_Header :user_info='user_info'/>    
    <v-main>
      <v-container>
        <v-responsive :max-width='1200' class='mx-auto'>
          <v-container>
            <ts_SelectCourse location='S_Course'/>
            <v-row>
              <v-container class='pt-5'>
                <ts_Course :course_id='props.course_id' />
              </v-container>
            </v-row>
          </v-container>
        </v-responsive>
